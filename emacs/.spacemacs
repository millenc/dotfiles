...
;; Custom: Send C-r "as-is" when in term mode to allow reverse search
...
;; Custom: Use pylint to lint python code
...
;; Custom: Ignore files and directories from search
